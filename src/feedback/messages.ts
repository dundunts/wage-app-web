...
export const feedbackMessages = {
    ...
    shiftResultDetailLoad: {
        success: "Данные результата смены загружены",
        error: "Данные результата смены не загружены",
        warning: "Загрузка результата смены требует внимания",
        information: "Загрузка результата смены",
        loading: "Данные результата смены загружаются",
    },
    shiftResultListLoad: {
        success: "Результаты смен загружены",
        error: "Результаты смен не загружены",
        warning: "Загрузка результатов смен требует внимания",
        information: "Загрузка результатов смен",
        loading: "Результаты смен загружаются",
    },
    shiftResultEmployeesLoad: {
        success: "Список сотрудников загружен",
        error: "Список сотрудников не загружен",
        warning: "Загрузка списка сотрудников требует внимания",
        information: "Загрузка списка сотрудников",
    ...
    salaryStatisticLoad: {
        success: "Статистика загружена",
        error: "Статистика не загружена",
        warning: "Загрузка статистики требует внимания",
        information: "Загрузка статистики",
        loading: "Статистика загружается",
    },
    checkpointCreate: {
